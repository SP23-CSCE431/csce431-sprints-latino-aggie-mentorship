...
u5 = Admin.create(email: "spottedelefant@tamu.edu", role: "mentor")
u6 = Admin.create(email: "justinhan@tamu.edu", role: "admin")
u7 = Admin.create(email: "ga220604@tamu.edu", role: "mentor")